  ...
  <div class="header">
    ...
    <transition>
      <div v-show="detailShow" class="detail">
        ...
        <div class="detail-close clearfix" @click="closeDetail">
      ...
      .detail-main{
        ...
        .supports{
          ...
          .support-item{
            ...
            & .decrease{
              .bg-image('../img/header/decrease_2');
            }
            & .discount{
              .bg-image('../img/header/discount_2');
            }
            & .guarantee{
              .bg-image('../img/header/guarantee_2');
            }
            & .invoice{
              .bg-image('../img/header/invoice_2');
            }
            & .special{
              .bg-image('../img/header/special_2');
            }
            .text{
              line-height: 15px;
              font-size: 12px;
